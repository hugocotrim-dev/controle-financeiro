...
@Component({
    ...
    <div class="auth-page">
      ...
      <div class="auth-content">
        <div class="auth-logo animate-fade-in">
          ...
          <p class="logo-tagline">Crie sua conta grátis</p>
        </div>

        <div class="auth-card animate-slide-up">
          <h2 class="auth-title">Cadastro</h2>
          <p class="auth-subtitle">Comece a controlar suas finanças hoje 🚀</p>
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <input id="name" name="name" type="text" class="form-control with-icon"
                  placeholder="João Silva" [(ngModel)]="name" required minlength="2" #nameInput="ngModel" />
              </div>
            ...
            <div class="form-group" style="margin-top:1rem">
              ...
              <div class="input-wrapper">
                ...
                <input id="password" name="password" [type]="showPassword() ? 'text' : 'password'"
                  class="form-control with-icon" placeholder="Mínimo 6 caracteres"
  ...
  styles: [`
    ...
    .logo-tagline { color:var(--color-text-muted);font-size:0.875rem; }
    .auth-card { width:100%;background:rgba(255,255,255,0.04);backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.08);border-radius:24px;padding:2rem; }
    .auth-title { font-size:1.5rem;font-weight:700;margin-bottom:0.25rem; }
    .auth-subtitle { color:var(--color-text-secondary);font-size:0.875rem;margin-bottom:1.5rem; }
    .auth-error { display:flex;align-items:center;gap:0.5rem;background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);border-radius:12px;padding:0.75rem 1rem;color:var(--color-red);font-size:0.875rem;margin-bottom:1rem; .material-icons-round{font-size:18px;} }
    .auth-success { display:flex;align-items:center;gap:0.5rem;background:rgba(16,185,129,0.1);border:1px solid rgba(16,185,129,0.3);border-radius:12px;padding:0.75rem 1rem;color:var(--color-green);font-size:0.875rem;margin-bottom:1rem; .material-icons-round{font-size:18px;} }
    .input-wrapper { position:relative;display:flex;align-items:center; }
    .input-icon { position:absolute;left:1rem;color:var(--color-text-muted);font-size:20px;pointer-events:none;z-index:1; }
    .form-control.with-icon { padding-left:3rem; }
    .input-toggle { position:absolute;right:0.75rem;background:none;border:none;cursor:pointer;color:var(--color-text-muted);display:flex;align-items:center;padding:0.25rem;border-radius:4px;transition:color 150ms; &:hover{color:var(--color-text-secondary);} .material-icons-round{font-size:20px;} }
    .field-error { font-size:0.75rem;color:var(--color-red);margin-top:0.25rem; }
    ...
    .auth-link { text-align:center;margin-top:1.5rem;color:var(--color-text-secondary);font-size:0.875rem; a{font-weight:600;color:var(--color-accent-light);} }
  `]
})
