...
var authGuard = () => {
  ...
  return toObservable(auth.loading).pipe(filter((loading) => !loading), take(1), map(() => {
    if (auth.isLoggedIn())
      return true;
...
var routes = [
  ...
  // Auth routes (public only)
  {
    ...
    children: [
      { path: "login", loadComponent: () => import("./chunk-45Y4SCBK.js").then((m) => m.LoginComponent) },
      { path: "register", loadComponent: () => import("./chunk-6HZ2MWBH.js").then((m) => m.RegisterComponent) },
  ...
  // Protected routes
  {
    ...
    loadComponent: () => import("./chunk-MMUSWRME.js").then((m) => m.DashboardComponent)
  },
  {
    path: "expenses",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-XJ364VUC.js").then((m) => m.ExpensesComponent)
  },
  {
    path: "income",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-YBD4BJKZ.js").then((m) => m.IncomeComponent)
  },
  {
    path: "goals",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-PT6BYN24.js").then((m) => m.GoalsComponent)
  },
  {
    path: "history",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-VXNWLAXS.js").then((m) => m.HistoryComponent)
  },
  {
    path: "settings",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-OZAHEAFZ.js").then((m) => m.SettingsComponent)
  },
  // Fallback
...
function BottomNavComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
...
var BottomNavComponent = class _BottomNavComponent {
  navItems = [
    { label: "In\xEDcio", icon: "home", route: "/dashboard" },
    ...
    { label: "Op\xE7\xF5es", icon: "settings", route: "/settings" }
  ];
  static \u0275fac = function BottomNavComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BottomNavComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BottomNavComponent, selectors: [["app-bottom-nav"]], decls: 7, vars: 0, consts: [[1, "sidebar-container"], [1, "sidebar-header"], [1, "logo-text"], [1, "sidebar-menu"], ["routerLinkActive", "active", 1, "sidebar-item", 3, "routerLink"], [1, "material-icons-round", "item-icon"], [1, "item-label"]], template: function BottomNavComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "aside", 0)(1, "div", 1)(2, "span", 2);
      \u0275\u0275text(3, "FinanceFlow");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(4, "nav", 3);
      \u0275\u0275repeaterCreate(5, BottomNavComponent_For_6_Template, 5, 3, "a", 4, _forTrack0);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;07c3bf79ba6920d1a95fe20f57cf2dab6420357d0b999c51cae70c5790cf6301;C:/Users/069027991147/Documents/controle-financeiro/src/app/shared/components/bottom-nav/bottom-nav.component.ts */\n.sidebar-container {\n  position: fixed;\n  background: rgba(15, 15, 15, 0.95);\n  backdrop-filter: blur(20px);\n  -webkit-backdrop-filter: blur(20px);\n  z-index: 100;\n  display: flex;\n}\n.sidebar-header {\n  display: flex;\n  align-items: center;\n}\n.sidebar-header .logo-text {\n  font-weight: 800;\n  background:\n    linear-gradient(\n      135deg,\n      #c084fc,\n      #a855f7);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  letter-spacing: -0.02em;\n}\n.sidebar-item {\n  display: flex;\n  align-items: center;\n  text-decoration: none;\n  color: var(--color-text-secondary);\n  transition: all 200ms ease;\n}\n.sidebar-item:hover {\n  background: rgba(255, 255, 255, 0.05);\n  color: var(--color-text-primary);\n}\n.sidebar-item.active {\n  background: rgba(168, 85, 247, 0.15);\n  color: var(--color-accent-light);\n}\n.sidebar-item.active .item-icon {\n  color: var(--color-accent-light);\n}\n.item-icon {\n  color: var(--color-text-muted);\n  transition: color 200ms ease;\n}\n.item-label {\n  font-weight: 600;\n}\n@media (min-width: 768px) {\n  .sidebar-container {\n    top: 0;\n    bottom: 0;\n    left: 0;\n    width: 260px;\n    flex-direction: column;\n    border-right: 1px solid rgba(255, 255, 255, 0.08);\n  }\n  .sidebar-header {\n    height: 68px;\n    padding: 0 1rem 0 1.5rem;\n    border-bottom: 1px solid rgba(255, 255, 255, 0.05);\n  }\n  .sidebar-header .logo-text {\n    font-size: 1.25rem;\n  }\n  .sidebar-menu {\n    padding: 1rem 0.75rem;\n    display: flex;\n    flex-direction: column;\n    gap: 0.375rem;\n    flex: 1;\n    overflow-y: auto;\n  }\n  .sidebar-item {\n    gap: 12px;\n    padding: 0.875rem 1rem;\n    border-radius: 12px;\n  }\n  .item-icon {\n    font-size: 22px;\n  }\n  .item-label {\n    font-size: 0.9375rem;\n  }\n}\n@media (max-width: 767px) {\n  .sidebar-container {\n    bottom: 0;\n    left: 0;\n    right: 0;\n    width: 100%;\n    height: var(--bottom-nav-height, 72px);\n    flex-direction: row;\n    border-top: 1px solid rgba(255, 255, 255, 0.08);\n    padding-bottom: env(safe-area-inset-bottom, 0px);\n  }\n  .sidebar-header {\n    display: none;\n  }\n  .sidebar-menu {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-around;\n    align-items: center;\n    width: 100%;\n    padding: 0 0.5rem;\n    gap: 0;\n  }\n  .sidebar-item {\n    flex-direction: column;\n    gap: 4px;\n    padding: 0.5rem 0.25rem;\n    border-radius: 8px;\n    flex: 1;\n    justify-content: center;\n  }\n  .sidebar-item.active {\n    background: transparent;\n  }\n  .sidebar-item.active .item-label {\n    color: var(--color-accent-light);\n  }\n  .item-icon {\n    font-size: 24px;\n  }\n  .item-label {\n    font-size: 0.7rem;\n  }\n}\n/*# sourceMappingURL=bottom-nav.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BottomNavComponent, { className: "BottomNavComponent", filePath: "src/app/shared/components/bottom-nav/bottom-nav.component.ts", lineNumber: 187 });
})();
...
function AppComponent_Conditional_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-bottom-nav");
  }
}
function AppComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AppComponent_Conditional_1_Conditional_0_Template, 1, 0, "app-bottom-nav");
    \u0275\u0275elementStart(1, "main", 4);
    \u0275\u0275element(2, "router-outlet");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r0.authService.isLoggedIn() ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("has-sidebar", ctx_r0.authService.isLoggedIn());
  }
}
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 2, vars: 1, consts: [[1, "global-loading"], [1, "loading-logo"], [1, "material-icons-round"], [1, "loading-spinner"], [1, "app-container"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, AppComponent_Conditional_0_Template, 5, 0, "div", 0)(1, AppComponent_Conditional_1_Template, 3, 3);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx.authService.loading() ? 0 : 1);
    }
  }, dependencies: [RouterOutlet, BottomNavComponent], styles: ["\n.global-loading[_ngcontent-%COMP%] {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 2rem;\n  background: #000;\n}\n.loading-logo[_ngcontent-%COMP%] {\n  width: 80px;\n  height: 80px;\n  border-radius: 22px;\n  background:\n    linear-gradient(\n      135deg,\n      #a855f7,\n      #7c3aed);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 0 40px rgba(168, 85, 247, 0.4);\n  animation: pulse-glow 2s infinite;\n}\n.loading-logo[_ngcontent-%COMP%]   .material-icons-round[_ngcontent-%COMP%] {\n  font-size: 40px;\n  color: white;\n}\n.loading-spinner[_ngcontent-%COMP%] {\n  width: 32px;\n  height: 32px;\n  border: 3px solid rgba(168, 85, 247, 0.2);\n  border-top-color: #a855f7;\n  border-radius: 50%;\n  animation: spin 0.8s linear infinite;\n}\n/*# sourceMappingURL=app.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, BottomNavComponent], template: `
  ...
  `, styles: ["/* angular:styles/component:scss;6583aee7e2eceb3ab43b777c2f067a5542a0119acb7082620020cbedefea1827;C:/Users/069027991147/Documents/controle-financeiro/src/app/app.ts */\n.global-loading {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 2rem;\n  background: #000;\n}\n.loading-logo {\n  width: 80px;\n  height: 80px;\n  border-radius: 22px;\n  background:\n    linear-gradient(\n      135deg,\n      #a855f7,\n      #7c3aed);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 0 40px rgba(168, 85, 247, 0.4);\n  animation: pulse-glow 2s infinite;\n}\n.loading-logo .material-icons-round {\n  font-size: 40px;\n  color: white;\n}\n.loading-spinner {\n  width: 32px;\n  height: 32px;\n  border: 3px solid rgba(168, 85, 247, 0.2);\n  border-top-color: #a855f7;\n  border-radius: 50%;\n  animation: spin 0.8s linear infinite;\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], () => [{ type: AuthService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src/app/app.ts", lineNumber: 65 });
})();
